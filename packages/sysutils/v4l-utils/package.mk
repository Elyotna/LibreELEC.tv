...
post_makeinstall_target() {
  ...
  multimap_default="cubox_i hp_mce rc6_mce xbox_one xbox_360 zotac_ad10"

  # create multimap_default
  create_multimap multimap_default "RC6 NEC" $multimap_default

  # create multimap_amlogic
  case $DEVICE in
    WeTek_Hub)
      create_multimap multimap_amlogic "RC6 NEC" $multimap_default wetek_hub
      ;;
    WeTek_Play_2)
      create_multimap multimap_amlogic "RC6 NEC" $multimap_default wetek_play_2
      ;;
    SML5442TW)
      create_multimap multimap_amlogic "RC6 NEC" $multimap_default
      ;;
    *)
      create_multimap multimap_amlogic "RC6 NEC" $multimap_default \
